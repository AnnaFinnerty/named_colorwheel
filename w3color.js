...
function toColorObject(c) {
  var x, y, typ, arr = [], arrlength, i, opacity, match, a, hue, sat, rgb, colornames = [], colorhexs = [], ncolRe;
  c = w3trim(c.toLowerCase());
  x = c.substr(0,1).toUpperCase();  //#
  y = c.substr(1);  //hex value (without hash)
  a = 1;
  ncolRe = /\d{5,}/;    
  ...
  var ind = getColorArr('hexs').indexOf(c);
    
  return colorObject(rgb, a, hue, sat, ind);
}
...
window.w3color.prototype = w3color.prototype;
